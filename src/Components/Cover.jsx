      ...
      <div className='grid grid-cols-1 md:grid-rows-4 md:grid-flow-col gap-4'>
          ...
          <div className='flex flex-col items-center'>
            ...
            <div className='flex gap-x-4 sm:gap-x-8 mt-4 sm:mr-4 justify-center'>
              <div className='flex gap-x-2 items-center'>
                <FaLocationDot />
                <h4 className='text-xs sm:text-sm'>Matara</h4>
              </div>
              <div className='flex gap-x-2 items-center'>
                <FaUserGraduate />
        ...
        <motion.div
          ...
          <div className='mt-4 sm:mt-8 pl-4 sm:pl-10 pb-4 sm:pb-7'>
            <h1 className='text-3xl sm:text-6xl text-slate-300 font-bold'>I'm <span className='text-blue-500'>Anuda Ransara</span> </h1>
            <h2 className='text-2xl sm:text-3xl text-slate-300 mt-3 sm:mt-5'>Full-Stack Software Engineer</h2>
