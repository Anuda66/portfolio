    ...
    <div className='px-4 sm:px-24' id="skills">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-14 mt-8 sm:mt-14'>
            ...
            <div className='grid grid-cols-3 gap-4 sm:gap-8 items-center mt-6 sm:mt-8'>
                {
                  framework.map((item)=>{
                    return(
                        <div key={item.id}>
                            <div className='bg-slate-900/50 border-[1px] border-blue-400 h-15 flex flex-col sm:flex-row gap-x-4 items-center justify-center rounded-2xl p-2'>
                            <div className='text-xl sm:text-3xl mb-1 sm:mb-0'>
                              <item.icon/>
                            </div>
                            <h1 className='text-sm sm:text-base text-slate-300 text-center'>{item.name}</h1>
                            </div>
                        </div>
                    );
                  })
            ...
            <motion.div
             ...
             transition={{duration:0.4, delay:0.3}}
            className='col-span-1 md:col-span-2 w-full md:w-[800px] mx-auto border-[1px] border-slate-500 p-4 sm:p-8 rounded-3xl shadow-[0_0_15px_0px_rgba(59,130,246,1)] hover:shadow-[0_0_25px_0px_rgba(59,130,246,1)]'>
